...
description: >
  Se mostrarán una serie de ejercicios. Cada uno tiene un espacio para ejecutar códigos de R. El apartado de *`Hint`* son pistas para resolver cada una de las preguntas..
---
...
¡Bien hecho! Has completado los ejercicios. Recuerda que la mejor manera de aprender este lenguaje, es equivocándonos, así que, no tengas miedo, ejecuta códigos y códigos aunque salgan errores, con práctica y con las bases teóricas del lenguaje, sabrás resolverlos. 